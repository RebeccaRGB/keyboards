...
public class KeyCapLegend implements Map<String,KeyCapLegendItem> {
	...
	public static final String KEY_LEFT_ALT_FUNCTION = "LAF";
	public static final String KEY_RIGHT_FUNCTION = "RF";
	public static final String KEY_RIGHT_ALT_FUNCTION = "RAF";
	...
	public static final String KEY_BOTH_UNSHIFTED = "BU";
	public static final String KEY_BOTH_SHIFTED = "BS";
	...
	public static final String KEY_FRONT_LEFT_ALT_FUNCTION = "FLAF";
	public static final String KEY_FRONT_RIGHT_FUNCTION = "FRF";
	public static final String KEY_FRONT_RIGHT_ALT_FUNCTION = "FRAF";
	...
	public static final String KEY_FRONT_BOTH_UNSHIFTED = "FBU";
	public static final String KEY_FRONT_BOTH_SHIFTED = "FBS";
